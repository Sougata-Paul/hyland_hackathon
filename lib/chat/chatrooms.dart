        ...
        children: [
          Expanded(
              child: contacts != null && contacts.size != 0
                  ...
                  : Center(child: Text("No Contacts Here",style: TextStyle(fontSize: MediaQuery.of(context).size.width*0.06,letterSpacing: MediaQuery.of(context).size.width*0.002,fontWeight: FontWeight.bold),)))
        ],
      ),
    );
  }
