...
class _appointmentState extends State<appointment> {
  ...
  getappointment()async{
      appointment=await firestore.collection('users').doc(user.uid).collection('doctor').get();
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("List Of Appointment"),),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height:5),
                                  Text(appointment.docs[index].data()['fees'].toString(),style: TextStyle(fontSize: 20),),
                                ]),
                          ),
                        );
                      },
